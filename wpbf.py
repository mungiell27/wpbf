...
if len(sys.ahrgv) <= 1:
    ...
    print 'WP-crack v1.0 (c)2012 by Zonesec - a very fast logon WordPress Cracker'
...
print 'WP-crack 1.0 (c)2012 by Zonesec - a very fast logon WordPress Cracker'
